                ...
                <div>
                  <div className="flex items-center justify-between">
                    <h4 className="font-medium">
                      {step.approvers[0]
                        ? `${step.approvers[0].first_name || ""} ${
                            step.approvers[0].last_name || ""
                          }`
                        : step.step_name}
                    </h4>
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getWorkflowStatusColor(
                        step.status
                      )}`}
                    >
                  ...
                  {step.approvers[0] && (
                    <div className="text-sm text-muted-foreground mt-1 flex items-center justify-between">
                      <span>{step.approvers[0].email}</span>
                      <span>
                        {step.approved_at ? (
                  ...
                  <TooltipProvider>
                    <Tooltip delayDuration={50}>
                      <TooltipTrigger asChild>
                        <span className="mt-2 block text-gray-600 italic text-sm truncate max-w-72 overflow-hidden">
