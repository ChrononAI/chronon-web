  ...
  const handleFiles = (files: File[]) => {
    const validFiles = files.filter(file => {
      ...
      if (!validTypes.includes(file.type)) {
        toast.error(`${file.name} is not a supported file type. Please upload PDF, DOC, DOCX, or TXT files.`);
        return false;
      }
        ...
        <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent rounded-lg p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Upload your organization's expense policy documents</p>
            </div>
          </div>
        </div>
          ...
          <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
            <div className="text-center space-y-6 p-8">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold">Processing Policy Document</h3>
                <p className="text-muted-foreground">{processingSteps[processingStep]}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <CardContent className="p-8">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-semibold">Upload your policy document</h3>
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Drag and drop your policy files here, or click the button below to browse
                  </p>
                </div>
